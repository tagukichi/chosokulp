				...
				<div class="sol-visual reveal reveal--right">
					<div class="mock-card mock-board">
						...
						<div class="mock-board-grid mock-board-grid--2col">
							...
							<div class="mock-block mock-block--text c2">
								<span class="mock-panel-tag">AI提案文</span>
								<span class="mock-skel w90"></span><span class="mock-skel w95"></span><span class="mock-skel w80"></span><span class="mock-skel w60"></span>
							</div>
							...
							<div class="mock-block c4"><span class="mock-panel-tag">人気店</span><span class="mock-skel w60"></span></div>
						</div>
					</div>
				</div>
			</div>
