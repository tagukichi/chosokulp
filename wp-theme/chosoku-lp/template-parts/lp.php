				...
				<div class="sol-visual reveal reveal--right">
					<div class="mock-card mock-board">
						...
						<div class="mock-board-grid mock-board-grid--2col">
							<div class="mock-block c1 swap-a">提案文<span class="mock-grab"></span></div>
							<div class="mock-block c2">物件位置</div>
							<div class="mock-block c3">法令制限</div>
							<div class="mock-block c4 swap-b">周辺施設<span class="mock-grab"></span></div>
							<div class="mock-block c1">価格情報</div>
							<div class="mock-block c2">人気店</div>
						</div>
					</div>
				</div>
			</div>
